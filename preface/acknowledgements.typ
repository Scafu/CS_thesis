...
#text(style: "italic")[
  ...
  #v(1em)
  Infine, un grazie di cuore ai colleghi di Wavelop Srl e ai fondatori, #myTutor e Nicola Capovilla, per l'opportunità
  di crescita professionale offerta durante il periodo di stage e per aver reso possibile lo sviluppo di questo
  progetto.
]
#v(2em)
