...
#[
  ...
  3. Dopo la verifica, il sistema invia una email all’utente che si sta registrando con un codice per poter attivare il
    proprio account.
  4. Quando l'utente inserisce il codice ricevuto nella webapp, il suo account viene attivato e ha la possibilità di
    accedere.
]
