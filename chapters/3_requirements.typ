...
- *Utente _Guest_*: rappresenta l'utente non autenticato che può accedere alla piattaforma senza effettuare il _login_.
  ...
  accedere alla gestione dei dati e a tutto quello che concerne le informazioni sanitarie offerte
  dall'applicazione#highlight(";")
...
*Task*: elenco di attività necessarie al completamento della storia#highlight(";")
...
#[
  ...
  #t
  1. #highlight("i")mplementazione pagine a _step_ del tutorial#highlight(";")
  2. #highlight("i")mplementazione bottone per saltare il tutorial#highlight(";")
  3. #highlight("i")mplementazione bottone "?" per visualizzare il tutorial in qualsiasi momento#highlight(";")
  4. #highlight("i")mplementazione logica per mostrare il tutorial alla prima misurazione e nasconderlo nelle
    misurazioni successive#highlight(";")
  5. #highlight("i")mplementazione salvataggio presa visione del tutorial#highlight(".")
  #p 2
  ...
  #t
  1. #highlight("i")mplementazione pagina di misurazione del piede#highlight(";")
  2. #highlight("i")mplementazione linee guida per la misurazione del piede#highlight(";")
  3. #highlight("i")mplementazione righello guida per la misurazione del piede#highlight(";")
  4. #highlight("i")mplementazione inserimento manuale della misura del piede#highlight(".")
  #p 3
  ...
  #t
  1. #highlight("i")mplementazione schermata di calcolo percentile#highlight(";")
  2. #highlight("i")mplementazione _Form_ per l'inserimento dei dati necessari al calcolo del percentile#highlight(";")
  3. #highlight("i")mplementazione grafici per la visualizzazione dei risultati del calcolo percentile#highlight(";")
  4. #highlight("i")mplementazione consiglio dell'esperto#highlight(";")
  5. #highlight("i")mplementazione logica di _routing_ per accedere alla schermata di calcolo percentile dalla
    Home#highlight(".")
  #p 3
  ...
  #t
  1. #highlight("i")mplementazione schermata di informazioni sanitarie#highlight(";")
  2. #highlight("i")mplementazione consigli sulle calzature adatte#highlight(";")
  3. #highlight("i")mplementazione consigli sullo sviluppo motorio#highlight(";")
  4. #highlight("i")mplementazione segnali di attenzione riguardo alla crescita del bambino#highlight(";")
  5. #highlight("i")mplementazione logica di _routing_ per accedere alla schermata di informazioni sanitarie dalla barra
    di navigazione#highlight(";")
  6. #highlight("i")mplementazione salvataggio informazioni come nota del diario di un bambino registrato#highlight(".")
  #p 2
  ...
  #t
  1. #highlight("i")mplementazione schermata del diario del bambino#highlight(";")
  2. #highlight("i")mplementazione visualizzazione misurazioni del piede/calcolo percentile effettuate in formato
    tabellare#highlight(";")
  3. #highlight("i")mplementazione visualizzazione misurazione del piede/calcolo percentile effettuate in formato
    grafico#highlight(";")
  4. #highlight("i")mplementazione visualizzazione note aggiuntive salvate#highlight(";")
  5. #highlight("i")mplementazione logica di _routing_ per accedere alla schermata del diario del bambino dalla
    _Home_#highlight(";")
  6. #highlight("i")mplementazione recupero dati dal _database_ locale/remoto#highlight(".")
  #p 5
  ...
  #t
  1. #highlight("i")mplementazione schermata contatti#highlight(";")
  2. #highlight("i")mplementazione _form_ di inserimento zona/indirizzo#highlight(";")
  3. #highlight("i")mplementazione visualizzazione lista card con i contatti degli esperti#highlight(";")
  4. #highlight("i")mplementazione calcolo distanza tramite dati nel _database_#highlight(";")
  5. #highlight("i")mplementazione logica di _routing_ per accedere alla schermata contatti dalla barra di
    navigazione#highlight(".")
  #p 3
  ...
  #t
  1. #highlight("i")mplementazione schermata _Home_#highlight(";")
  2. #highlight("i")mplementazione logica di _routing_ per accedere alle altre schermate#highlight(";")
  3. #highlight("i")mplementazione visualizzazione funzionalità principali dell'applicazione#highlight(";")
  4. #highlight("i")mplementazione sezioni sfocata con richiesta di registrazione/login per visualizzare i dati
    completi#highlight(".")
  #p 2
  ...
  #t
  1. #highlight("i")mplementazione schermata iniziale o _Splash Screen_#highlight(";")
  2. #highlight("i")mplementazione visualizzazione logo dell'applicazione#highlight(";")
  3. #highlight("i")mplementazione logica di _routing_ per accedere alla schermata _Home_ dopo un breve periodo di
    tempo#highlight(".")
  #p 1
  ...
  ognuno di essi.
  #t
  1. #highlight("i")mplementazione sezione di gestione bambini registrati con lista dinamica#highlight(";")
  2. #highlight("i")mplementazione logica di registrazione e rimozione bambino#highlight(";")
  3. #highlight("i")mplementazione _multi-tenancy_ per gestire i dati di più bambini in modo separato#highlight(";")
  4. #highlight("i")mplementazione operazioni _Create, Read, Update e Delete_ (CRUD) sui dati di ogni bambino#highlight(
      ";",
    )
  5. #highlight("i")mplementazione logica di _routing_ per accedere alla sezione di registrazione tramite pulsante nella
    schermata _Home_#highlight(";")
  6. #highlight("i")mplementazione _form_ per l'inserimento dei dati necessari alla registrazione di un
    bambino#highlight(".")
  #p 5
  ...
  #t
  1. #highlight("i")mplementazione autenticazione tramite _Auth0_#highlight(";")
  2. #highlight("i")mplementazione logica di registrazione e login tramite _Auth0_#highlight(";")
  3. #highlight("i")mplementazione logica di _logout_ tramite _Auth0_#highlight(";")
  4. #highlight("i")mplementazione logica di gestione sessione utente#highlight(";")
  5. #highlight("i")mplementazione logica di protezione delle rotte per le funzionalità riservate agli utenti
    autenticati#highlight(".")
  #p 2
  ...
  #t
  1. #highlight("i")mplementazione logica di eliminazione account utente#highlight(";")
  2. #highlight("i")mplementazione logica di eliminazione dati associati all'account utente#highlight(";")
  3. #highlight("i")mplementazione logica di conferma dell'eliminazione account e dati#highlight(";")
  4. #highlight("i")mplementazione _reset_ dell'applicazione dopo l'eliminazione account e dati#highlight(";")
  5. #highlight("i")mplementazione pulsanti e messaggi di conferma per l'eliminazione account e dati#highlight(";")
  6. #highlight("i")mplementazione logica per eliminare diari di bambini registrati a scelta dell'utente#highlight(".")
  #p 3
  ...
  #t
  1. #highlight("i")mplementazione motore di misurazione del piede#highlight(";")
  2. #highlight("i")mplementazione conversione da _pixel_ a centimetri#highlight(";")
  3. #highlight("i")mplementazione conversione centimetri a taglie di calzature#highlight(";")
  3. #highlight("i")mplementazione salvataggio dati in database locale/remoto#highlight(".")
  #p 5
  ...
  #t
  1. #highlight("i")mplementazione motore di calcolo percentile#highlight(";")
  2. #highlight("i")mplementazione salvataggio dati in database locale/remoto#highlight(".")
  #p 5
  ...
  #t
  1. #highlight("i")mplementazione schermata di impostazioni dell'applicazione#highlight(";")
  2. #highlight("i")mplementazione cambio tema dell'applicazione#highlight(";")
  3. #highlight("i")mplementazione cambio lingua dell'applicazione#highlight(";")
  4. #highlight("i")mplementazione salvataggio preferenze dell'utente in database locale/remoto#highlight(";")
  5. #highlight("i")mplementazione logica di _routing_ per accedere alla sezione di impostazioni tramite pulsante nella
    barra di navigazione#highlight(";")
  6. #highlight("i")mplementazione internazionalizzazione dell'applicazione per supportare più lingue#highlight(".")
  #p 2
]
