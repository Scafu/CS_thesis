...
disposizione un diario digitale basato sulle misurazioni effettuate sul bambino tramite un sistema touch che consente di
misurare direttamente il piede attraverso lo schermo dello _smartphone_.
#v(1em)
...
/ #link(<cap:descrizione-stage>)[Il secondo capitolo]: descrive in dettaglio il percorso di stage, illustrando gli
  ...
  #v(0.5em)
/ #link(<cap:analisi-requisiti>)[Il terzo capitolo] Il terzo capitolo: descrive il progetto da un punto di vista
  analitico, descrivendo i casi d'uso e i relativi requisiti.
  #v(0.5em)
/ #link(<cap:tecnologie>)[Il quarto capitolo] Il quarto capitolo: descrive le tecnologie adottate per lo sviluppo
  dell'applicazione, illustrando le motivazioni alla base della scelta e le caratteristiche principali di ciascuna
  tecnologia.
  #v(0.5em)
/ #link(<cap:progettazione-e-codifica>)[Il quinto capitolo]Il quinto capitolo: descrive il progetto da un punto di vista
  progettuale, illustrando le scelte architetturali, la progettazione dell'interfaccia utente.
  #v(0.5em)
